...
import {
  GetFinancialTransactionsReport,
...
const scanApiDetail = {
  url: GetFinancialTransactionsReport,
...
const handleFilterChange = (values: {
  ...
  const transformedData = data?.data?.items?.map((item: any) => ({
    ...
    transactionType: <TableCell>{item.transactionType?.title}</TableCell>,
    PersonName: <TableCell>{item.PersonName}</TableCell>,
    roleName: <TableCell>{item.roleName}</TableCell>,
    transactionReasonType: (
      <TableCell>{item.transactionReasonType?.title}</TableCell>
    ),
    createDate: <TableCell>{item.createDate}</TableCell>,
    transactionStatusId: (
      <Tag
        categoryName="transactionStatusId"
        id={item.transactionStatusId}
          ...
          <div className="">
            <DynamicTable
              ...
              headers={[
                ...
                { key: "transactionId", label: "کد تراکنش", sortable: true },
                { key: "amount", label: "مبلغ", sortable: false },
                { key: "createdDate", label: "تاریخ", sortable: true },
                { key: "transactionType", label: "نوع تراکنش", sortable: true },
                { key: "PersonName", label: "کاربر", sortable: false },
                { key: "roleName", label: "نقش", sortable: false },
                {
                  key: "transactionReasonType",
                  label: "بابت",
                  sortable: false,
                },
                {
