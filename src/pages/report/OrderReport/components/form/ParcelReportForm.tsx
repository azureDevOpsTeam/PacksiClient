          ...
          <div className="">
            <DynamicTable
              ...
              headers={[
                ...
                { key: "parcelCount", label: "تعداد مرسوله", sortable: true },
                {
                  key: "orderType",
                  label: "سرویس",
                  // sortable: true,
                ...
                { key: "totalPrice", label: "هزینه نهایی", sortable: false },
                { key: "orderStatus", label: "آخرین وضعیت", sortable: false },
              ]}
