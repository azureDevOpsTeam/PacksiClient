...
const handleFilterChange = (values: {
  ...
  const transformedData = data?.data?.items?.map((item: any) => ({
    original: item,
    Id: item.customerId,
    cooperationStartDate: <TableCell>{item.cooperationStartDate}</TableCell>,
    cooperationEndDate: <TableCell>{item.cooperationEndDate}</TableCell>,
    lastSettlementDate: <TableCell>{item.lastSettlementDate}</TableCell>,
    monthlyCredit: <TableCell>{item.monthlyCredit}</TableCell>,
            ...
            <DynamicTable
              ...
              headers={[
                ...
                },
                {
                  ...
                  label: "انقضای قرارداد",
                  // sortable: true,
                },
                {
                  key: "lastSettlementDate",
                  label: "آخرین تسویه حساب",
                  sortable: false,
                },
                {
                  key: "monthlyCredit",
                  label: "مقدار اعتبار ماهیانه",
                  sortable: false,
                },
                { key: "totalDebt", label: "مبلغ بدهی", sortable: false },
              ]}
